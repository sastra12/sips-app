...
@push('script')
    <script>
        ...
        function checkMonthlyBillPaid() {
            $.ajax({
                url: "{{ route('monthlyBillPaidFacilitator') }}",
                type: "GET",
                data: {
                    bankId: bankId,
        ...
        function checkMonthlyBillUnpaid() {
            $.ajax({
                url: "{{ route('monthlyBillUnpaidFacilitator') }}",
                type: "GET",
                data: {
                    bankId: bankId,
        ...
        $("#downloadDataUnpaid").click(function(e) {
            ...
            let downloadUrl = "{{ route('export-customer-unpaid-facilitator') }}?month_payment=" + month_payment +
