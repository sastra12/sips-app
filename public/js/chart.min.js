...
class LineController extends DatasetController {
    ...
    updateElements(e, i, t, a) {
        ...
        var { sharedOptions: h, includeOptions: d } = this._getSharedOptions(
                i,
                a
            ),
            c = n.axis,
...
class PolarAreaController extends DatasetController {
    ...
    updateElements(a, t, e, s) {
        ...
        for (g = t; g < t + e; g++) {
            ...
            (u = e),
                n &&
                    (o.animateScale && (i = 0), o.animateRotate && (t = e = c));
            var m = {
                x: h,
                y: d,
                innerRadius: 0,
        ...
        evaluateInteractionItems(n, t, r, function (t, e, i) {
            ...
            (o && !s) ||
                ...
                (h || n.isPointInArea(a) || s) &&
                    ((s = c(r, a)) < u
                        ? ((d = [{ element: t, datasetIndex: e, index: i }]),
                          (u = s))
                        : s === u &&
                          d.push({ element: t, datasetIndex: e, index: i })));
        }),
        d
    );
}
        ...
        d &&
            ...
            c
                ? ((t.width = this.maxWidth),
                  (t.height = getTickMarkLength(h) + d))
...
function retrieveAxisFromDatasets(e, t) {
    if (t.data && t.data.datasets) {
        ...
        if (t.length)
            return (
                getAxisFromDataset(e, "x", t[0]) ||
                getAxisFromDataset(e, "y", t[0])
            );
    }
    return {};
}
...
function pathSegment(t, e, i, a) {
    ...
    for (u = 0; u <= l; ++u)
        (g = s[(o + (c ? l - u : u)) % r]).skip ||
            (d ? (t.moveTo(g.x, g.y), (d = !1)) : h(t, p, g, c, n.stepped),
            (p = g));
        ...
        this.legendItems.forEach((t, e) => {
            ...
            (e = e),
                ...
                w
                    ...
                    ? ((c = _.lineHeight),
                      (D.y += calculateLegendItemHeight(t, c) + y))
                    : (D.y += O);
        }),
...
function drawPointLabels(e, i) {
    ...
    for (let t = i - 1; 0 <= t; t--) {
        ...
        h.visible &&
            (drawPointLabelBox(
                a,
                (n = s.setContext(e.getPointLabelContext(t))),
                h
            ),
            (r = toFont(n.font)),
